...
class APodDaoTest {
    ...
    fun insertAndRetrieveAPod() {
        val podDate = LocalDate.parse("2019-08-22")
        val aPod = APod(
            date = podDate,
    ...
    fun insertAndRetrieveAnotherNotPresentAPod() {
        val podDate = LocalDate.parse("2019-08-24")
        val fetchDate = LocalDate.parse("2019-08-22")
        ...
        runBlocking {
            ...
            assertNull(aPodDao.getAPod(fetchDate))
        }
    }
